...
//View1darray.data.ImageData
        let obj = {
            input: data[0].data // the array of pixels (and potentially their RGB channel/s) 
...
/* 
  ...
  */
    ...
    // next task; better split the data, or get more data to act as the validation/test data 